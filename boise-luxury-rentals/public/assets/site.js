(function () {
  ...
  // ---- Lightbox ----
  var items = Array.prototype.slice.call(document.querySelectorAll('.gallery .ph img, .mosaic .ph img'))
    .filter(function (i) { return i.complete ? i.naturalWidth > 0 : true; });
  ...
  if (lb && items.length) {
    ...
    var show = function (i) {
      ...
      big.src = items[idx].getAttribute('data-full') || items[idx].src;
